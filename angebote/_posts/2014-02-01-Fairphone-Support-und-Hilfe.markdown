  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="large-3 columns">
            ...
            <small class="error">Telefon obligatorisch.</small>
          </div>
      <div class="large-3 columns">
            <label>Kursdatum:
...
### Weitere Fairphone Anwendungen die Sie bei uns in persönlichen Hilfestunden oder im Fairphone-Workshop erlernen können
